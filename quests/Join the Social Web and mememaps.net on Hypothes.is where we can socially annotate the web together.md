...
* To get an idea what Social Annotation is all about check out
	...
	* [[Jordy from mememaps.net|Jordy]]'s annotations [here](https://hypothes.is/users/jordyarms?q=)
* Make an account on [Hypothes.is here](https://hypothes.is/signup)
* Go to  [[mememaps.net community links]], join the Discord, and check the pinned message in the `#memex-general` channel
* Install the Browser Extension or Bookmarket
