...
- [[core/principles]] - P3 (Semantic Richness), P9 (Performance)
- [[analysis/gap-analysis]] - Query approaches address multiple gaps
- [[analysis/glossary-engineering]] - Technical term definitions
- [[context/landscape/storage-models]] - Storage affects query capability
- [[context/cases/atproto-analysis]] - Graph + temporal queries
