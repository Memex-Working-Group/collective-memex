...
**Related Terms:** See [[analysis/glossary-engineering]] - RDF, SPARQL, Ontology
...
**Related Terms:** See [[analysis/glossary-engineering]] - Lexicon System, JSON-LD
...
**Related Terms:** See [[analysis/glossary-engineering]] - Property Graph, Graph Traversal
...
- [[core/principles]] - P3 (Semantic Richness), P4 (Schema Pluralism)
- [[analysis/system-evaluation]] - How real systems score on these dimensions
- [[analysis/gap-analysis]] - GAP-3 (Semantic richness vs performance tradeoff)
- [[analysis/glossary-engineering]] - Technical term definitions
- [[context/cases/atproto-analysis]] - Lexicon system in practice
