...
* Type: Side Project
* Code: [Memex-Working-Group/website-to-markdown-scraper](https://github.com/Memex-Working-Group/website-to-markdown-scraper)
...
* Type: Side Project
* Description:
	* A custom written sense making harness with custom written extensions like reflection
	* Can be accessed via Matrix Protocol similar to how [[Open Claw]] is accessed via [[Telegram]]
* Next Steps:
...
## [Web Command Content Modeling Standard](https://www.webcomand.com/blog/content_modeling_standard-941471/)

* By: [Mitch Bechtel](https://www.linkedin.com/in/mitchbechtel/)
* Type: Startup
* Description:
