...
* It has some great analytics
	* IT can track what you are spending
* It has a webui, `hermes dashboard`
* It can be remotely connected through through most chat apps like [[Telegram]] among many others
* Can delegate coding tasks to proper coding harnesses like [[OpenCode]], [[OpenAI Codex]] and [[Claude Code]]
