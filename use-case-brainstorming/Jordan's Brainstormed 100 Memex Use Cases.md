...
_Relating to past and future versions of yourself as distinct entities_
...
_Forensic investigation of where thoughts, beliefs, and desires come from_
...
_Thinking as fundamentally shared, merged, or interpersonal_
...
_Maintaining records of the forbidden, shameful, or denied_
...
_Cognition in relation to death, loss, and testimony_
...
_Tools for observing your own cognitive processes_
...
_Examining the political and social contamination of knowledge_
...
_Using the memex against dominant systems_
...
_Interfacing with radically different minds_
...
_Thought as inseparable from body and emotion_
...
_Non-waking cognition as navigable territory_
...
_How language shapes and constrains cognition_
...
_Place as cognitive infrastructure_
...
_How beauty and taste structure thought_
...
_Memory in the register of play_
...
_Memory at the scale of history_
...
_Institutions sensing their own context_
...
_Memory infrastructure for trust and privacy_
...
Starting from the provided prompt framework, 48 initial use cases were generated, calibrated against the examples provided (e.g., "Trauma Topology," "Archaeological Desire," "Cognitive Xenobiology") and explicitly avoiding pedestrian productivity features.

**Phase 2: Categorical Analysis**
The initial 48 use cases were analyzed to identify emergent clusters:
...
Analysis revealed underexplored territories:
...
**Phase 4: Modality Expansion**
Exploration of capture modalities beyond text:
...
Exploration of memory at different scales:
...
**Phase 6: Teleological Analysis**
The question "What is memory for?" yielded purposes:
...
Integration of all phases into 100 categorized use cases with emphasis on the speculative, philosophically engaged, and culturally transformative.
...
_Document generated through human-AI collaboration, January 2026_